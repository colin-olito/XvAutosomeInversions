...
recessiveData  <-  makeReplicateAutoInvSimsData(nReps = 3e+5, N.vals = c(500, 1000), m.vals = c(0.005, 0.01), 
												s = 0.05, h = 0, r = 0.1, n = 100, u = 1e-5, h.del = 0, 
												newMutant = 'random') 

# Additive fitness effects
additiveData  <-  makeReplicateAutoInvSimsData(nReps = 3e+5, N.vals = c(500, 1000), m.vals = c(0.005, 0.01), 
												s = 0.05, h = 1/2, r = 0.1, n = 100, u = 1e-5, h.del = 0, 
												newMutant = 'random') 

# Locally adaptive alleles dominant
dominantData  <-  makeReplicateAutoInvSimsData(nReps = 3e+5, N.vals = c(500, 1000), m.vals = c(0.005, 0.01), 
